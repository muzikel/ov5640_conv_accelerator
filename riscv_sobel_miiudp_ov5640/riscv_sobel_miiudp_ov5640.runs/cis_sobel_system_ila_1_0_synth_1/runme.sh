...
HD_PWD='D:/ProjectVivado/ov5640_mii_udp2/riscv_sobel_miiudp_ov5640/riscv_sobel_miiudp_ov5640.runs/cis_sobel_system_ila_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cis_sobel_system_ila_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cis_sobel_system_ila_1_0.tcl
