...
module e203_subsys_perips(
  ...
  //  * GPIOB      
   ...
   //  *      
    ...
    .o15_icb_cmd_valid  (PE_icb_cmd_valid),
    .o15_icb_cmd_ready  (PE_icb_cmd_ready),
    .o15_icb_cmd_addr   (PE_icb_cmd_addr),
    .o15_icb_cmd_read   (PE_icb_cmd_read),
    .o15_icb_cmd_wdata  (PE_icb_cmd_wdata),
    .o15_icb_cmd_wmask  (PE_icb_cmd_wmask),
    .o15_icb_cmd_lock   (),
    .o15_icb_cmd_excl   (),
    .o15_icb_cmd_size   (PE_icb_cmd_size),
    .o15_icb_cmd_burst  (),
    .o15_icb_cmd_beat   (),
    
    .o15_icb_rsp_valid  (PE_icb_rsp_valid),
    .o15_icb_rsp_ready  (PE_icb_rsp_ready),
    .o15_icb_rsp_err    (PE_icb_rsp_err),
    .o15_icb_rsp_excl_ok(1'b0),
    .o15_icb_rsp_rdata  (PE_icb_rsp_rdata),
