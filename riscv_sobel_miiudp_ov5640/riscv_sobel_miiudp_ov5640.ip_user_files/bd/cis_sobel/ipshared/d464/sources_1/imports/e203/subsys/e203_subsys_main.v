...
e203_subsys_mems u_e203_subsys_mems(
    ...
    .rst_n         (per_rst_n),
    //AXI peripheral
    .expl_axi_arvalid (m_axi_arvalid),
    .expl_axi_arready (m_axi_arready),
    .expl_axi_araddr   (m_axi_araddr),
  
    .expl_axi_arcache  (m_axi_arcache),
    .expl_axi_arprot   (m_axi_arprot),
    .expl_axi_arlock   (m_axi_arlock),
    .expl_axi_arburst  (m_axi_arburst),
    .expl_axi_arlen    (m_axi_arlen),
    .expl_axi_arsize   (m_axi_arsize),

    .expl_axi_awvalid (m_axi_awvalid),
    .expl_axi_awready (m_axi_awready),
    .expl_axi_awaddr  (m_axi_awaddr),
    .expl_axi_awcache (m_axi_awcache),
    .expl_axi_awprot  (m_axi_awprot),
    .expl_axi_awlock  (m_axi_awlock),
    .expl_axi_awburst (m_axi_awburst),
    .expl_axi_awlen   (m_axi_awlen),
    .expl_axi_awsize (m_axi_awsize),

    .expl_axi_rvalid (m_axi_rvalid),
    .expl_axi_rready (m_axi_rready),
    .expl_axi_rdata  (m_axi_rdata),
    .expl_axi_rresp  (m_axi_rresp),
    .expl_axi_rlast  (m_axi_rlast),

    .expl_axi_wvalid (m_axi_wvalid),
    .expl_axi_wready (m_axi_wready),
    .expl_axi_wdata  (m_axi_wdata),
    .expl_axi_wstrb  (m_axi_wstrb),
    .expl_axi_wlast  (m_axi_wlast),

    .expl_axi_bvalid (m_axi_bvalid),
    .expl_axi_bready (m_axi_bready),
    .expl_axi_bresp (m_axi_bresp)  
  );
