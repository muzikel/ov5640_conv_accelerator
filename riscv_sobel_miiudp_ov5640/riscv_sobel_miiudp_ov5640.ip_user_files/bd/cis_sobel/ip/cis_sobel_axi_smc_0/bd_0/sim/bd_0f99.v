...
//--------------------------------------------------------------------------------
//Command: generate_target bd_0f99.bd
//Design : bd_0f99
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_0f99,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_0f99,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=40,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "cis_sobel_axi_smc_0.hwdef" *) 
module bd_0f99
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S00_AXI, ADDR_WIDTH 28, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN cis_sobel_mig_7series_0_0_ui_clk, DATA_WIDTH 128, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 4, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [27:0]S00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S00_AXI AWADDR" *) input [27:0]S00_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S01_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S01_AXI, ADDR_WIDTH 28, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN cis_sobel_mig_7series_0_0_ui_clk, DATA_WIDTH 128, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 4, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [27:0]S01_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S01_AXI AWADDR" *) input [27:0]S01_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN cis_sobel_mig_7series_0_0_ui_clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0" *) input aclk;
  ...
  wire [27:0]s00_entry_pipeline_m_axi_ARADDR;
  ...
  wire [27:0]s00_entry_pipeline_m_axi_AWADDR;
  ...
  wire [133:0]s00_nodes_M_SC_AR_PAYLD;
  ...
  wire [133:0]s00_nodes_M_SC_AW_PAYLD;
  ...
  wire [27:0]s01_entry_pipeline_m_axi_ARADDR;
  ...
  wire [27:0]s01_entry_pipeline_m_axi_AWADDR;
  ...
  wire [133:0]s01_nodes_M_SC_AR_PAYLD;
  ...
  wire [133:0]s01_nodes_M_SC_AW_PAYLD;
  ...
  assign S00_AXI_1_ARADDR = S00_AXI_araddr[27:0];
  ...
  assign S00_AXI_1_AWADDR = S00_AXI_awaddr[27:0];
  ...
  assign S01_AXI_1_ARADDR = S01_AXI_araddr[27:0];
  ...
  assign S01_AXI_1_AWADDR = S01_AXI_awaddr[27:0];
  ...
  m00_exit_pipeline_imp_HGIYOW m00_exit_pipeline
  ...
  m00_nodes_imp_UR88P8 m00_nodes
  ...
  s00_entry_pipeline_imp_1GNKSGZ s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_1AQZ5MH s00_nodes
  ...
  s01_entry_pipeline_imp_AQOWZB s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_ETWBPR s01_nodes
  ...
  switchboards_imp_1I98J71 switchboards
...
module m00_exit_pipeline_imp_HGIYOW
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module m00_nodes_imp_UR88P8
  ...
  wire [133:0]m00_ar_node_M_SC_PAYLD;
  ...
  wire [133:0]m00_aw_node_M_SC_PAYLD;
  ...
  assign M_SC_AR_payld[133:0] = m00_ar_node_M_SC_PAYLD;
  ...
  assign M_SC_AW_payld[133:0] = m00_aw_node_M_SC_PAYLD;
  ...
  assign S_SC_AR_1_PAYLD = S_SC_AR_payld[133:0];
  ...
  assign S_SC_AW_1_PAYLD = S_SC_AW_payld[133:0];
...
module s00_entry_pipeline_imp_1GNKSGZ
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  wire aclk_1;
  wire aresetn_1;
  wire [27:0]s00_mmu_M_AXI_ARADDR;
  ...
  wire [27:0]s00_mmu_M_AXI_AWADDR;
  ...
  wire [27:0]s00_si_converter_M_AXI_ARADDR;
  ...
  wire [27:0]s00_si_converter_M_AXI_AWADDR;
  ...
  wire [27:0]s00_transaction_regulator_M_AXI_ARADDR;
  ...
  wire [27:0]s00_transaction_regulator_M_AXI_AWADDR;
  ...
  assign aclk_1 = aclk;
  assign aresetn_1 = aresetn;
  assign m_axi_araddr[27:0] = s00_si_converter_M_AXI_ARADDR;
  ...
  assign m_axi_awaddr[27:0] = s00_si_converter_M_AXI_AWADDR;
  ...
  bd_0f99_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_0f99_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_0f99_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s00_nodes_imp_1AQZ5MH
  ...
  assign M_SC_AR_payld[133:0] = s00_ar_node_M_SC_PAYLD;
  ...
  assign M_SC_AW_payld[133:0] = s00_aw_node_M_SC_PAYLD;
...
module s01_entry_pipeline_imp_AQOWZB
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  wire aclk_1;
  wire aresetn_1;
  wire [27:0]s01_mmu_M_AXI_ARADDR;
  ...
  wire [27:0]s01_mmu_M_AXI_AWADDR;
  ...
  wire [27:0]s01_si_converter_M_AXI_ARADDR;
  ...
  wire [27:0]s01_si_converter_M_AXI_AWADDR;
  ...
  wire [27:0]s01_transaction_regulator_M_AXI_ARADDR;
  ...
  wire [27:0]s01_transaction_regulator_M_AXI_AWADDR;
  ...
  assign aclk_1 = aclk;
  assign aresetn_1 = aresetn;
  assign m_axi_araddr[27:0] = s01_si_converter_M_AXI_ARADDR;
  ...
  assign m_axi_awaddr[27:0] = s01_si_converter_M_AXI_AWADDR;
  ...
  bd_0f99_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_0f99_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_0f99_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s01_nodes_imp_ETWBPR
  ...
  assign M_SC_AR_payld[133:0] = s01_ar_node_M_SC_PAYLD;
  ...
  assign M_SC_AW_payld[133:0] = s01_aw_node_M_SC_PAYLD;
...
module switchboards_imp_1I98J71
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
  ...
  wire [133:0]ar_switchboard_M00_SC_PAYLD;
  ...
  wire [133:0]aw_switchboard_M00_SC_PAYLD;
  ...
  assign M00_SC_AR_payld[133:0] = ar_switchboard_M00_SC_PAYLD;
  ...
  assign M00_SC_AW_payld[133:0] = aw_switchboard_M00_SC_PAYLD;
  ...
  assign S00_SC_AR_1_PAYLD = S00_SC_AR_payld[133:0];
  ...
  assign S00_SC_AW_1_PAYLD = S00_SC_AW_payld[133:0];
  ...
  assign S01_SC_AR_1_PAYLD = S01_SC_AR_payld[133:0];
  ...
  assign S01_SC_AW_1_PAYLD = S01_SC_AW_payld[133:0];
