...
#
# Generated by Vivado on Wed Jun 02 12:50:52 +0800 2021
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0f99.protoinst" -protoinst "protoinst_files/cis_sobel.protoinst" -log simulate.log
}
