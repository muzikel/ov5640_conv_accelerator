...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L util_vector_logic_v2_0_1 -L xlconstant_v1_1_6 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L smartconnect_v1_0 -L fifo_generator_v13_2_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cis_sobel xil_defaultlib.cis_sobel xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cis_sobel -key {Behavioral:sim_1:Functional:cis_sobel} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0f99.protoinst" -protoinst "protoinst_files/cis_sobel.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cis_sobel.wdb xsim.dir)
